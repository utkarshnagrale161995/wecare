...
export default function RescheduleAppointment(){
    ...
    const bookingId = useSelector(state=>state.rescheduleAppointmentIdreducer.bookingid)
        ...
        <>
              <div className="navbar bg-dark navbar-dark navbar-expand-sm">
                    <ul className="navbar-nav">
                       ...
                       <li className="nav-item"><Link className="nav-link" to='/viewUserProfile'>View Profile</Link></li>
                       ...
                       <li onClick={handleLogout} className="nav-item"><Link className="nav-link">Logout</Link></li>
                    </ul>
                    </div>
                    <br></br>
                    <br></br>
                    <div className="container w-50">
                        <div className="card bg-black ">
                                <div className="card-header text-center text-light">Reschedule your Appointment</div>
                                      <div className="card-body">
                                               ...
                                               <p><select name="slot" value={state.slot} onChange={handleChange}>
                                                ...
                                                <button className="btn btn-primary" onClick={handleClick}>Reschedule your Appointment</button>
